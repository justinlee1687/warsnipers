...
- **Please be specific with your troop requests.** If you do not wish to use the in-game feature to request a specific composition, you may list the troops you want or ask for '<span style="color:#3fa63f; font-style:italic">Any Ground</span>' or '<span style="color:#3fa63f; font-style:italic">Any Air</span>'. If at all possible, please do not request just any! If you choose to do so, you may receive any unit, even ones you may not want.
...
{:.no_toc}
+ Make sure you use a proper strategy when attacking for 3 stars. You may receive a warning or strike if you fail your mirror attack repeatedly without notifying the leader.
...
+ **On a Non-FWA war** (*Blacklisted clan or Mismatch*)**:**
...
Our clan works with a few other clans in our discord to organize CWL in new seperate clans. This allows us to run Lazy CWL at the same time as our FWA wars. Spots in CWL are first come, first served. Details will be announced by @Justin in the ws2g-announcements channel on Discord. Enabling push notifications for that channel is recommended.
