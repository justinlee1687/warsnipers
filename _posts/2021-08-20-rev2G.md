...
| **Clan Tag:** | [#298VGUJ2](https://link.clashofclans.com/en?action=OpenClanProfile&tag=298VGUJ2) ([Open Clash of Stats](https://www.clashofstats.com/clans/war-snipers-2.g-298VGUJ2/members/)) |
| **Clan Level:** | 30 |
...
### 1. All members must request and donate a minimum of 1000 troops per season.
{:.no_toc}
- Members at *Town Hall 11* are exempt from the *Donations requirement*.
...
+ If multiple players are online attacking districts, please call out your attacks. Do not attack a district that has been hit already without checking in chat that no one else is planning to finish it. If in doubt, ask, dont snipe.
...
> <span style="color:$primary-color; font-size:1.25em; font-weight:bold">The password for new members is "Purple Platypus"</span><br>
