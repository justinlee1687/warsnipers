...
{: .notice--info}**We do not enforce any Donation/Request ratio.** So long as you are meeting the donation requirement, you may request as much as you want.
...
{: .notice--danger}If other players are online attacking districts, please call out your attacks. Only attack a district that has been hit already if no one in chat is planning to finish it. If in doubt, ask, dont snipe.
...
{: .notice--info}Repeatedly over or understarring will result in removal from the clan.
