...
### 1a. Must follow rules regarding donations/requests: {:.no_toc}
...
### 1b. Must follow the general rules below: {:.no_toc}
- Do not donate any troops to the clan war clan castles.
- Only use English in clan chats.

### 2. Must use ALL Clan Capital attacks during the Raid Weekend. {:.no_toc}
...
###### Raid Weekend Rules. (Updated Sept 24 2022) {:.no_toc}
...
### 3. Must earn a minimum of 1000 points from the monthly Clan Games. {:.no_toc}

### 4. Must use both attacks in FWA wars as directed by the clan mail. {:.no_toc}
+  **WIN war:**
...
### 5. Must notify leadership BEFORE leaving the clan or going inactive. {:.no_toc}
...
###### Insta-kicks are given for: {:.no_toc}
