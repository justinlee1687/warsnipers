...
- Clashperk's */donation* in #ws2x-bot will be used to determine your donations each season.
...
{:.no_toc}
- Please use all of your attacks, so all 6 attacks. You could be striked if you do not use 6/6 attacks.
...
**Miscellaneous**:
- Not attacking during raid weekends.
