...
- Try not to be too picky when requesting, so everyone can donate. For example, if you need sneakies in a blimp, you can request 9 sneakies with the rest of the request being any. You should avoid using raid medals for requests unless no one else is online or you're bypassing the request cooldown.
