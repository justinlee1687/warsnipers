...
- **We encourage non-empty troop requests.** Make donating easier for your clanmates by asking for what you need.
...
- See [Capital Raid Guide](http://tiny.cc/capitalraidguide) for a guide that's likely semi out of date but probably still applicable.

Our clans progress very quickly through clan capital, and may occasionally be maxed. Please refer to #ws2x-capital-announcements or in game pins for the latest information regarding where you can dump your capital gold if applicable. The same rules as CWL hopping applies, see Basic Guidelines in the [CWL](#i-want-to-participate-in-cwl-where-and-how-can-i-do-that) section for more detail.
{: .notice--info}
...
+ **Attack your mirror within the first 20 hours of war day.**
  ...
  - <span style="color:#B22222; font-weight:bold">Never use both attacks in the same war on loot.</span> Doing so without permission is 2 strikes.	
...
In order to consistently match with other FWA clans, we must maintain our war weight within certain ranges. Members must regularly communicate their TH upgrading plans to leadership in #ws2x-chat. We may request that you delay your TH upgrade to max out more or hold off on upgrading certain defenses to prevent matching issues. Failure to comply may result in removal. 
{: .notice--info}
...
- Please note that a certain level of leader discretion applies. Repeats of the same offense could potentially lead to being removed from the clan before a member is eligible for a kick with the strike system.  

#### Strike Types: 
{:.no_toc}
  <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span> - 1 Strike;  <span style="color:#fd8c00; font-weight:bold; font-style: italic">High</span> - 1 Season Strike; <span style="color:#B22222; font-weight:bold; font-style: italic"> Critical</span>- 2 Strikes; <span style="color:#8E1B1B; background-color: #000000; font-weight:bold; font-style: italic">Instant Kick</span> - 4 Strikes

### Strikes are given for: 
{:.no_toc}

- **FWA Attack related**:
  - Not attacking in war. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Not attacking mirror first. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Failure to follow war plan - 1 starring mirror instead of 2 or 3 starring. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Failure to follow war plan - Stealing stars from other members when looting or cleaning up. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Failure to follow war plan - 3 starring on loss. <span style="color:#B22222; font-weight:bold; font-style: italic"> Critical</span>
  - Hitting 1 & 2 when you're not supposed to. <span style="color:#B22222; font-weight:bold; font-style: italic"> Critical</span>
  
- **Clan minimums related**:
  - Not getting 1000 clan game points minimum. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Not getting the minimum donations per season. <span style="color:#fd8c00; font-weight:bold; font-style: italic">High</span>
  - Not getting the minimum receives per season. <span style="color:#fd8c00; font-weight:bold; font-style: italic">High</span>
  - Not getting the minimum combined total of donation and receives per season. <span style="color:#fd8c00; font-weight:bold; font-style: italic">High</span>
  
- **Miscellaneous**:
  - Did not start attacks during raid weekend. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Incomplete attacks during raid weekends. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Being reported for wrong donations in the clan. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Not switching your base during blacklisted wars. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Not using both attacks in blacklisted wars. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Lingering in the CWL clan for too long. <span style="color:#fdc500; font-weight:bold; font-style: italic">Medium</span>
  - Not fixing errors in FWA base within 48 hours of being notified. <span style="color:#fd8c00; font-weight:bold; font-style: italic">High</span>
  - Not having FWA base active. <span style="color:#8E1B1B; background-color: #000000; font-weight:bold; font-style: italic">Instant Kick</span> 
  - Donating troops to FWA Clan Castle. <span style="color:#8E1B1B; background-color: #000000; font-weight:bold; font-style: italic">Instant Kick</span>
  - Disruption to the clan, *as per leader discretion <span style="color:#8E1B1B; background-color: #000000; font-weight:bold; font-style: italic">Instant Kick</span>
