...
+ All Members must donate and receive a combined total of <span style="color:#3fa63f; font-style:italic">3600 </span> troops.
  + Clashperks <span style="color:#3fa63f; font-style:italic">/donations</span> command in #ws2x-bot will be used to determine your stats each season.
...
+ **Attack your mirror within the first 20 hours of war day.**
  ...
  - <span style="color:#A63FA6; font-weight:bold">Never attack 1 & 2.</span> Doing so without permission is 2 strikes.	
...
- Strikes reset monthly after season reset. Clan minimums related strikes of the next month are accounted for in the previous season before resetting to prevent members from slacking with d/r repeatedly.
...
{:.no_toc}
Double weighted strikes are highlighted in purple.

**FWA Attack related**:
- Not attacking in war.
- Not attacking mirror first.
- Failure to follow war plan - 1 starring mirror instead of 2/3 starring.
-  <span style="color:#A63FA6">Failure to follow war plan - 3 starring on loss.</span>
-  <span style="color:#A63FA6">Hitting 1 & 2 when you're not supposed to. </span>
