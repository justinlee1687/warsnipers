...
- The last day of the season, every member should have a combined donated + received total of at least 4000 troop spaces (minimum 1000 combined each week). Members who joined mid-season are not subjected to this rule. There's no fixed d/r ratio to be followed.
- A mid season donation and received check will be done halfway through each season to encourage more activity. In a season, Members are expected to have a combined donate + received total of AT LEAST 2000 troops 2 weeks into the season.
- Clan Games participation is mandatory. The amount of points to get may vary, so that will be communicated via clan mail (Generally it is 1500 when max tier is 50k).
...
Clan members get 5-6 STRIKES before they are kicked (leadership has discretion on the exact number based on the severity of the strikes). Based on the gravity of their mistakes, they may or may not be accepted back in the future.

Strikes are reset every 2 seasons.

| **1 STRIKES:**<br>- **Failure to meet Mid season check**<br>- **Missing war hits.**<br>- **Incorrect donations (with provided screenshot evidence).**<br>- **Getting incorrect \# of stars by not following war mail.**<br>- **Failure to do at least 5 attacks in capital raid weekend. (Recommended: 6 attacks every raid weekend)**<br>- **Failure to meet Clan Games required points (1500).**<br>- **Missing Fwa war search (e.g. Due to lingering in cwl clan, visiting other clan etc).**|
| **2 STRIKES:** <br> - **Failure to meet combined Troop Donated + Received requirement. (4000+)**<br>- **Not fixing errors in the active FWA base after being notified (e.g. Air X-Bows, range overlaps etc).**<br>- **Breaking any major rule in the discord server (e.g. serious spamming, posting questionable content in family friendly channels, mass tagging etc).**|
| **3 STRIKES:** <br> - **Failure to meet combined Troop Donated + Received requirement for a second consecutive season.**|
...
- For 10,000+ donation OR 10,000+ received you can get 1 strike reduced (if you have any strike)
- Getting 10,000+ points in a clan game will remove 1 strike (if you have any strike)
...
So far you have read the basic rules required to know for joining the clan. Send "_Jon Snow_" in #waiting_list or wherever you're asked to read rules to show you have read rules carefully.
...
If you wish to apply, send a dm to **ak** on discord. State your timezone/location and a brief text to convince him ;). A minimum of a few weeks of staying in the clan are required to be considered for Elder, and a few months as Elder are required to be considered for Co-Leader.
...
- Change: Donation/received requirement is now a single combined 4000 total instead of separate 1200/1200 minimums.
- Change: Failure to meet combined D+R requirement is now always 2 strikes (was 1 for missing either donate or receive, 2 for missing both), with a new 3-strike tier for a second consecutive season failure.
- Change: Clan Games required points raised to 1500 (was 1000).
- Change: Strike removal threshold raised to 10,000+ donation/received/clan games points (was 4000/max).
- Change: Strikes given for donations or clan games can now be reduced/removed like any other strike (previously excluded).
- Change: Kick threshold is now 5-6 strikes (leadership discretion), reset every 2 seasons.
