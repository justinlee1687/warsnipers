...
- Clashperks <span style="color:#3fa63f; font-style:italic">/donations</span> command in #ws2g-bot is be used to determine your stats each season.
  ...
  - Troops requested must exceed <span style="color:#3fa63f; font-style:italic">3000</span> per season
...
Leadership reserves to have the right to remove any member for any reason, for example if they are deemed to be doing the minimum for multiple consecutive seasons, the member is not being a team player, or they're the least active member of their Town Hall level and the clan needs to adjust it's war weight.

The number of strikes given for a particular offense is based on the severity of the offense and the members previous record. You can see how many strikes you have by entering any bot channel and using the command *!strikes*

Entering strikes is manual and they may be assigned any time after an offense is commited. An offense may be counted against you or used in a decision to kick even if it hasn't been entered into the system yet. Strikes may be removed if the member reports and owns up to their mistake or when they have avoided receiving new strikes for at least 3 months.
## Strikable Offenses:
{:.no_toc}
#### **FWA War related**:
{:.no_toc}
...
- Star stealing - attacking another clanmates mirror within the first 16 hours of war day
- Failure to follow war plan - 1 or 0 starring mirror
- Failure to follow war plan - 3 starring on loss
- Hitting 1 & 2 without permission
...
#### **Raid Weekend**:
{:.no_toc}
- Not using all attacks during raid weekend (Should be at 6 out of 6 attacks, a warning will be given once if at 5 out of 5)
- Did not attack in raid weekend at all
- Failing to finish off a district before attacking another one

#### **CWL**:
{:.no_toc}
- Lingering in the CWL clan for more than 1 hour *Warning*
- Not attacking mirror in CWL
- Missing an FWA sync during CWL
#### **Miscellaneous**:
{:.no_toc}
