...
4. **No member may leave for CWL after FWA war has ended in the main clan.** Multiple members have choosen to do so despite warnings and have missed the start of the next FWA war as a result. If you take the risk anyway and miss FWA sync, you will be banned from the next CWL. **Any member who misses more than 3 FWA syncs during any CWL will be permanently removed from the clan.**
	
5. Must notify leadership if unable to play Clash for any period of time.
